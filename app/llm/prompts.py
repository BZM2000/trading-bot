...
def build_model1_user_prompt(context: Model1Context) -> str:
    ...
    prompt = [
        ...
        "Take-profit / stop-loss legs are normally staged after fills—SELL trigger brackets are the only bundled exception. Do not assume any other multi-leg orders in one step.",
    ]
    return "\n".join(prompt)
